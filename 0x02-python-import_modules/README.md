...
In this project, some inbuilt python modules were used to learn how to import fuctions and classes from packages. Relative import of local modules was also used to learn how to use functions in different files.
