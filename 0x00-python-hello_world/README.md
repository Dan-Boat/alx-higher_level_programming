...
Note: You can make the github file executable with the command

*git update-index --chmod=+x filename* (if it fails to push the executable from the local directory)
...
* **13. ByteCode -> Python #1**
  * [102-magic_calculation.py](./102-magic_calculation.py): Python function matching exactly
  ...
  (c) Daniel Boateng ALX-Africa Software Engineering