...
This project covers aliasing, object identifiers, types, cloning, and mutability. The project involved a series of quiz-like questions the answers to which I provided in single-line `.txt` files.
